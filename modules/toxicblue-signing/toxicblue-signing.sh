...
cp "$MODULE_DIRECTORY/toxicblue-signing/policy.json" $CONTAINER_DIR/policy.json
cp "$MODULE_DIRECTORY/toxicblue-signing/policy.json" $ETC_CONTAINER_DIR/policy.json
...
sed -i "s ghcr.io/IMAGENAME $IMAGE_REGISTRY g" "$MODULE_DIRECTORY/toxicblue-signing/registry-config.yaml"
cp "$MODULE_DIRECTORY/toxicblue-signing/registry-config.yaml" "$CONTAINER_DIR/registries.d/$IMAGE_REGISTRY_TITLE.yaml"
cp "$MODULE_DIRECTORY/toxicblue-signing/registry-config.yaml" "$ETC_CONTAINER_DIR/registries.d/$IMAGE_REGISTRY_TITLE.yaml"
rm "$MODULE_DIRECTORY/toxicblue-signing/registry-config.yaml"
